...
def cacaded_weighted_dice_coefficient_loss(y_pred, y_true, smooth=0.00001):
    y_whole = K.eval(y_true)
    y_core = K.eval(y_true)
    y_enh = K.eval(y_true)
    ...
    loss_whole = 1 - dice_coefficient(y_pred[0], K.variable(y_whole))
    loss_core = 1 - dice_coefficient(y_pred[1], K.variable(y_core))
    loss_enh = 1 - dice_coefficient(y_pred[2], K.variable(y_enh))
