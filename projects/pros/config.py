...
config["all_modalities"] = ["imaging"]
config["training_modalities"] = config["all_modalities"]
config["nb_channels"] = len(config["training_modalities"])
config["truth_old"] = ["segmentation"]
config["truth"] = ["segmentation"]
...
config["brats_folder"] = "projects/pros"
config["dataset_folder"] = "projects/pros/database"
config["template_data_folder"] = "database/data_train"
config["template_folder"] = "case_00000"
...
config_dict["is_denoise"] = ["0", "bm4d", "median"]
