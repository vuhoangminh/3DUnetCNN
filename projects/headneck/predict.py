...
from projects.headneck.config import config, config_unet, config_dict
...
def predict(args, prediction_dir="desktop"):
    ...
    if not os.path.exists(model_path):
        ...
        if prediction_dir == "SERVER":
            prediction_dir = "projects/headneck"
        else:
        ...
        if is_all_cases_predicted(config["prediction_folder"], config["testing_file"]):
            ...
            if args.model_dim == 3:
                ...
                from projects.headneck.prediction import run_validation_cases
