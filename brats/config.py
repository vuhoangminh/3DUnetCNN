...
config_unet["initial_learning_rate"] = 10*0.00001 # factor by which the learning rate will be reduced
...
config_dict["is_denoise"] = ["0", "bm4d", "nonlocal", "bilateral", "gaussian"]
config_dict["is_normalize"] = ["0", "z", "piecewise", "minh"]
